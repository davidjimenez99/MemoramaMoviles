...
public class Dificil extends AppCompatActivity {
    ...
    private ImageView places[]=new ImageView[24];
    private boolean usedPlaces[]=new boolean[24];
    int contVolt=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        places[16]=(ImageView)findViewById(R.id.img17);
        places[17]=(ImageView)findViewById(R.id.img18);
        places[18]=(ImageView)findViewById(R.id.img19);
        places[19]=(ImageView)findViewById(R.id.img20);
        places[20]=(ImageView)findViewById(R.id.img21);
        places[21]=(ImageView)findViewById(R.id.img22);
        places[22]=(ImageView)findViewById(R.id.img23);
        places[23]=(ImageView)findViewById(R.id.img24);
